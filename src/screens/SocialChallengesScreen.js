...
const styles = StyleSheet.create({
  ...
  track: { height: 8, borderRadius: 999, backgroundColor: colors.surface2, overflow: 'hidden' }, fill: { height: '100%', backgroundColor: colors.accent, borderRadius: 999 }, progressMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, strong: { color: colors.text, fontSize: 11, fontWeight: '800' }, people: { gap: 7 }, person: { flexDirection: 'row', alignItems: 'center', gap: 8 }, personRank: { color: colors.textDim, width: 14, fontSize: 10, fontWeight: '900' }, personName: { flex: 1, color: colors.text, fontSize: 11, fontWeight: '700' }, personProgress: { color: colors.accentStrong, fontSize: 10, fontWeight: '900' }, actions: { flexDirection: 'row', gap: 8 }, decline: { flex: 1, alignItems: 'center', backgroundColor: colors.surface2, borderRadius: 999, paddingVertical: 10 }, declineText: { color: colors.textDim, fontSize: 12, fontWeight: '800' }, accept: { flex: 1.4, alignItems: 'center', backgroundColor: colors.accent, borderRadius: 999, paddingVertical: 10 }, acceptText: { color: colors.bg, fontSize: 12, fontWeight: '900' },
});
