...
const styles = StyleSheet.create({
  ...
  challenge: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: 18, padding: 14, gap: 12 }, completed: { borderColor: colors.accent }, challengeTop: { flexDirection: 'row', alignItems: 'center', gap: 10 }, roundIcon: { width: 42, height: 42, borderRadius: 21, backgroundColor: colors.surface2, alignItems: 'center', justifyContent: 'center' }, cardTitle: { color: colors.text, fontSize: 14, fontWeight: '800', flex: 1 }, muted: { color: colors.textDim, fontSize: 11, lineHeight: 16 }, join: { backgroundColor: colors.surface2, borderRadius: 999, alignItems: 'center', paddingVertical: 10 }, joinText: { color: colors.accentStrong, fontSize: 12, fontWeight: '800' }, goal: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: 16, padding: 13, gap: 11 }, track: { height: 7, backgroundColor: colors.surface2, borderRadius: 999, overflow: 'hidden' }, fill: { height: '100%', backgroundColor: colors.accent, borderRadius: 999 }, progressMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, progressStrong: { color: colors.text, fontSize: 11, fontWeight: '800' }, badgeGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 }, badge: { width: '48%', minHeight: 120, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: 16, padding: 13, gap: 6 }, locked: { opacity: 0.48 }, badgeTitle: { color: colors.text, fontSize: 13, fontWeight: '800' }, badgeDesc: { color: colors.textDim, fontSize: 10, lineHeight: 14 },
});
