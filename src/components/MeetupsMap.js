...
const styles = StyleSheet.create({
  ...
  hint: { position: 'absolute', top: 10, alignSelf: 'center', flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(15,23,18,0.88)', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 },
  hintText: { color: colors.text, fontSize: 10, fontWeight: '700' },
  marker: { position: 'absolute', width: 38, height: 42, alignItems: 'center' },
  zoomControls: { position: 'absolute', right: 10, top: 52, borderRadius: 10, overflow: 'hidden', backgroundColor: 'rgba(15,23,18,0.9)', borderWidth: 1, borderColor: colors.line },
