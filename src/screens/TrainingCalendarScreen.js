...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: colors.bg }, content: { padding: 16, paddingBottom: 46, gap: 12 }, intro: { paddingVertical: 6 }, eyebrow: { color: colors.accentStrong, fontSize: 10, fontWeight: '900', letterSpacing: 1 }, title: { color: colors.text, fontSize: 23, fontWeight: '900', marginVertical: 4 }, muted: { color: colors.textDim, fontSize: 11, lineHeight: 16 }, form: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: 19, padding: 14, gap: 11 }, label: { color: colors.textDim, fontSize: 10, textTransform: 'uppercase', fontWeight: '800' }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 }, chip: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: colors.surface2, borderRadius: 999, paddingHorizontal: 11, paddingVertical: 8 }, chipActive: { backgroundColor: colors.accent }, chipText: { color: colors.textDim, fontSize: 11, fontWeight: '700' }, chipTextActive: { color: colors.bg }, input: { color: colors.text, backgroundColor: colors.surface2, borderRadius: 13, paddingHorizontal: 12, paddingVertical: 11, fontSize: 12 }, primary: { backgroundColor: colors.accent, borderRadius: 999, paddingVertical: 13, alignItems: 'center' }, primaryText: { color: colors.bg, fontWeight: '900', fontSize: 13 }, heading: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 8 }, headingText: { color: colors.text, fontSize: 16, fontWeight: '900' }, count: { color: colors.bg, backgroundColor: colors.accentStrong, minWidth: 20, height: 20, borderRadius: 10, textAlign: 'center', lineHeight: 20, fontSize: 10, fontWeight: '900' }, empty: { borderWidth: 1, borderColor: colors.line, borderStyle: 'dashed', borderRadius: 17, padding: 22, alignItems: 'center', gap: 9 }, event: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: 17, padding: 12 }, date: { width: 46, height: 52, borderRadius: 13, backgroundColor: colors.surface2, alignItems: 'center', justifyContent: 'center' }, day: { color: colors.text, fontSize: 18, fontWeight: '900' }, month: { color: colors.accentStrong, fontSize: 9, fontWeight: '900' }, eventTitle: { color: colors.text, fontSize: 13, fontWeight: '800', marginBottom: 2 }, state: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 5 }, stateText: { color: colors.textDim, fontSize: 9, fontWeight: '700' }, eventActions: { gap: 7 }, done: { width: 34, height: 34, borderRadius: 17, backgroundColor: colors.accent, alignItems: 'center', justifyContent: 'center' }, skip: { width: 34, height: 34, borderRadius: 17, backgroundColor: colors.surface2, alignItems: 'center', justifyContent: 'center' },
});
